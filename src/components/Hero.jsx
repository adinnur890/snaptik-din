...
const BADGES = [
  ...
  { icon: <Shield size={11} />, label: "No Login",       color: "#25F4EE" },
  { icon: <Globe size={11} />,  label: "Always Free",   color: "#a78bfa" },
  { icon: <Film size={11} />,   label: "HD Quality",    color: "#34d399" },
];

const STATS = [
  { value: "HD",   label: "Quality" },
  { value: "Zero", label: "Watermark" },
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-4 items-center min-h-[calc(100vh-6rem)]">
          ...
          <div className="flex flex-col justify-center order-2 lg:order-1 py-8 lg:py-0">
            ...
            >
              Paste any TikTok link and download instantly — no account, no watermark, no nonsense.
            </motion.p>
